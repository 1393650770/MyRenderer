...
// -- [AI] Empty graph should validate OK
TEST(empty_graph)
{
...
// -- [AI] Simple valid graph: pass writes resource, another reads it
TEST(simple_valid)
{
	RenderGraphDefinition def;
...
// -- [AI] Duplicate pass names should fail
...
// -- [AI] Cycle detection: A->B->A should fail
...
// -- [AI] Unconnected read should fail (no producer for read resource)
...
// -- [AI] Orphaned output should produce warning (not error)
