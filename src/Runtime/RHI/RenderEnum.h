...
MYRENDERER_BEGIN_NAMESPACE(MXRender)
	...
	enum class ENUM_TEXTURE_USAGE_TYPE :UInt32
	{
		...
		ENUM_TYPE_PRESENT_SWAPCHAIN = 1 << 1,
		ENUM_TYPE_COPY = 1 << 2,
		ENUM_TYPE_SHADERRESOURCE = 1 << 3,
		ENUM_TYPE_DEPTH_ATTACHMENT = 1 << 4,
		ENUM_TYPE_DEPTH_ATTACHMENT_READ_ONLY = 1 << 5,
		ENUM_TYPE_DEPTH_ATTACHMENT_WRITE_ONLY = 1 << 6,
		ENUM_TYPE_STORAGE = 1 << 7,
	};
	...
	public:
		...
		{
			return fail_op == rhs.fail_op && depth_fail_op == rhs.depth_fail_op && pass_op == rhs.pass_op && func == rhs.func;
		}
