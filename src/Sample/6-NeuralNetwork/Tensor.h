...
public:
	Tensor() MYDEFAULT;
	explicit Tensor(CONST Vector<UInt32>& in_shape, ENUM_TENSOR_DTYPE in_dtype = ENUM_TENSOR_DTYPE::Float32);
	~Tensor();
	...
	size_t ByteSize() CONST { return element_count_ * ElementByteSize(); }
...
private:
	...
	ENUM_TENSOR_DTYPE dtype_ = ENUM_TENSOR_DTYPE::Float32;
#pragma endregion
